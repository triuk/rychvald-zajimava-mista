...
- **Rychvaldský zámek – datace částečně vyřešena:** detail Památkového katalogu (`web-npu-rychvald-zamek-detail`, oddíl „Anotace“) a oficiální web města (`web-mesto-rychvald-o-meste`, oddíl „Památky“) shodně uvádějí výstavbu v letech 1575–1577. `rz-2011-11`, s. 8 přitom rozlišuje získání panství Burianem Barským roku 1573 a následnou výstavbu synem Bernardem. Samotný rok 1573 v `rz-2011-04`, s. 3 je proto hodnocen jako pravděpodobná záměna těchto událostí. Rok 1595 v `kronika-ka631`, ř. 4564–4575 zůstává neověřenou variantou; je nutné porovnat přepis s obrazovým originálem a ideálně se stavebněhistorickým průzkumem evidovaným NPÚ.
