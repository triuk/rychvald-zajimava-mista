# OCR scény: výstavní panely rychvaldského ochotnického divadla
...
Na panelu jsou dále rozeznatelné názvy nebo nadpisy samostatně dochovaných dokumentů:

- `Večer tříkrálový`;
- `Slavnost lampiónů`;
- `Čestné uznání`;
- přehled činnosti Miroslava Neboráka;
- fotografie, programy a popisky rolí.

Tyto vložené dokumenty nebyly z celkového záběru znovu přepisovány.

## Panel 2 – festivalový plakát

**ONV FRENŠTÁT P. R. A ODO FRENŠTÁT P. R.**

pořádají v rámci oslav 15. výročí osvobození ČSR sovětskou armádou
...
## Další velké nadpisy na panelu 2
